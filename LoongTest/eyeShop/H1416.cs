...
namespace eyeShop
{
    ...
    public partial class H1416
    {
        ...
        public Nullable<decimal> Qty_InWip { get; set; }
        public Nullable<decimal> Qty_InFgs { get; set; }
        public Nullable<decimal> Qty_OutOther { get; set; }
        public Nullable<decimal> Qty_Bal { get; set; }
        public Nullable<decimal> Qty_InFgsAll { get; set; }
        public decimal qty_InOther { get; set; }
    }
}
